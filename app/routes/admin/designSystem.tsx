export default () => (
  <div className="prose">
    <h1>Prose</h1>
    <p>
      This represents the default padding and spacing for prose on your website
      paragraphs and other long runs of text will look like this. Lorem ipsum
    ...
    <div className="flex flex-row flex-wrap">
      ...
      <div className="h-24 w-24 bg-primary-400"></div>
      <div className="h-24 w-24 bg-primary-500"></div>
      <div className="h-24 w-24 bg-primary-600"></div>
      <div className="h-24 w-24 bg-primary-700"></div>
      <div className="h-24 w-24 bg-primary-800"></div>
      <div className="h-24 w-24 bg-primary-900"></div>
    </div>
    <p>Secondary</p>
