...
Hey! Everything is set up. Wow. Look at the browser, your website is running locally. Just change this file and save, and the changes will be reflected immediately. More detailed directions are in the git repo, which I also left open in your browser.

I also went to the liberty of configuring your text editor for writing. I did the following:
